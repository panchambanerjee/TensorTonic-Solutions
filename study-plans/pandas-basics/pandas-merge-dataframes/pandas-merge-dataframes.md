...
* <span style="font-size: 14px;">**One-to-one**: Each key appears at most once in each table. The output row count depends on the join type and which keys overlap.</span>
...
* <span style="font-size: 14px;">**NaN keys**: Pandas matches missing keys to missing keys, unlike ordinary SQL joins.</span>
* <span style="font-size: 14px;">**Type mismatch**: Incompatible key dtypes, such as integer keys and string keys, can raise an error. Use compatible key types.</span>
