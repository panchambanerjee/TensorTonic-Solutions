...
* <span style="font-size: 14px;">**Duplicate indices**: Preserving overlapping row labels can make a label-based lookup return multiple rows. Reset the index when unique consecutive labels are needed.</span>
